...
UPLOAD_FOLDER = '/home/vivaainng/Desktop/AnomalyDetectionCVPR2018/SampleVideos'
...
def upload_data():
    ...
    if request.method == 'POST':
        ...
        temporal_ann_path = '/home/vivaainng/Desktop/AnomalyDetectionCVPR2018/Eval_Res/Temporal_Annotations/' + filename[:-3] + 'mat'
        temporal_ann = loadmat(temporal_ann_path)
        temporal_ann = temporal_ann['Annotation_file']['Anno']
        annotations = temporal_ann[0, 0]

    return render_template('line_chart.html',values=y, labels=x, legend=filename[:-6], annotations=annotations)
